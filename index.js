        ...
        getDoc(userDocRef)
            .then((docSnap) => {
                if (docSnap.exists()) {
                    ...
                    const previousScore = docSnap.data().MyBeatScore || 0;
                    const scoreHistory = docSnap.data().MyBeatScoreHistory || []; // Get existing score history or default to empty array
                    ...
                    return updateDoc(userDocRef, {
                        ...
                        MyBeatScore: newScore,
                        MyBeatScoreHistory: [...scoreHistory, score] // Append new score to history
                    });
                } else {
